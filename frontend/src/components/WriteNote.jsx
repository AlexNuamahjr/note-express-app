            ...
            <div className="d-flex align-items-center justify-content-between">
              <div className="iq-note-callapse-menu">
                <a
                  ...
                  data-extra-className-show=".hide-note-button"
                  data-extra-className-hide=".show-note-button"
                  aria-expanded="false"
                >
              ...
              <div className="note-right media align-items-top hide-note-button d-none">
                <div className="mr-2">
                  <a
                    href="#"
                    className="btn view-btn body-bg"
                    data-toggle="modal"
                  ...
                  <div className="dropdown">
                    ...
                    >
                      <a className="dropdown-item" href="#">
                        <i className="lar la-heart mr-3"></i>Add To Favourite
                      </a>
                      <a className="dropdown-item" href="#">
                        <i className="las la-thumbtack mr-3"></i>Mark As Pin
                      </a>
                      <a className="dropdown-item" href="#">
                        <i className="las la-trash-alt mr-3"></i>Move to Trash
                      </a>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-12 p-0 d-flex justify-content-end">
                      <button
                        ...
                        data-extra-toggle="toggle"
                        data-extra-className-show=".show-note-button"
                        data-extra-className-hide=".hide-note-button"
                      >
                        Close
                      </button>
                      <button
            ...
            <div className="card-body custom-notes-space">
              ...
              <div className="iq-tab-content">
                      ...
                      <div className="dropdown">
                        ...
                        >
                          ...
                          <div className="dropdown-item mb-2">
                            <div className="d-flex align-items-center justify-content-between">
                              <h6 className="mr-4">
                                <i className="las la-calendar mr-3"></i>Created
                              </h6>
                              <div className="form-group mb-0">
                                <select
                                  id="date-select"
                ...
                <div className="note-content tab-content">
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-4 col-md-6">
                          <div className="card card-block card-stretch card-height card-bottom-border-purple note-detail">
                            ...
                            <div className="card-body rounded">
                              <h4 className="card-title">Birthday Celebration</h4>
                              <p className="mb-3 card-description short">
                          ...
                          <div className="card card-block card-stretch card-height card-bottom-border-warning note-detail">
                            ...
                            <div className="card-body rounded">
                              ...
                              <ul className="pl-3 mb-0">
                                ...
                                <li className="note-list mb-2">300 Words only.</li>
                                <li className="note-list">Make presentation.</li>
                              </ul>
                            </div>
                            <div className="card-footer">
                        ...
                        <div className="col-lg-4 col-md-6">
                          <div className="card card-block card-stretch card-height card-bottom-border-danger note-detail">
                            <div className="card-header d-flex justify-content-between pb-1">
                              <div className="icon iq-icon-box-2 icon-border-danger rounded">
                                <svg
                                  width="23"
                                  height="23"
                                  className="svg-icon"
                                ...
                                <div className="card-header-toolbar d-flex align-items-center">
                                  <div className="dropdown">
                                    ...
                                    >
                                      <a
                                        href="#"
                                        className="dropdown-item new-note4"
                                        data-toggle="modal"
                            ...
                            <div className="card-body rounded">
                              <h4 className="card-title">Lecture Notes</h4>
                              <div className="checkbox mb-2">
                                <input
                                  type="checkbox"
                                  className="checkbox-input mr-3"
                                  id="checkbox18"
                                />
                                <label
                                  for="checkbox18"
                                  className="note-checkbox mb-0"
                                >
                                  Chapter 1 notes.
                                </label>
                              </div>
                            ...
                            <div className="card-footer">
                              <div className="d-flex align-items-center justify-content-between note-text note-text-danger">
                                <a href="#" className="">
                                  <i className="las la-user mr-2 font-size-20"></i>
                                  Only You
                                </a>
                        ...
                        <div className="col-lg-4 col-md-6">
                          <div className="card card-block card-stretch card-height card-bottom-border-primary note-detail">
                            <div className="card-header d-flex justify-content-between pb-1">
                                ...
                                <div className="card-header-toolbar d-flex align-items-center">
                                  <div className="dropdown">
                                    ...
                                    >
                                      <a
                                        href="#"
                                        className="dropdown-item new-note5"
                                        data-toggle="modal"
                            ...
                            <div className="card-body rounded">
                              <h4 className="card-title">Image Notes</h4>
                              <ul className="row mb-0 p-0 list-inline flex-wrap align-items-center">
                                <li className="col-4">
                                  <a href="#">
                                    <img
                                      src="../assets/images/gallery/grid/08.jpg"
                                      className="img-fluid note-image rounded"
                                      alt=""
                                    />
                                  </a>
                                </li>
                            ...
                            <div className="card-footer">
                              <div className="d-flex align-items-center justify-content-between note-text note-text-primary">
                                <a href="#" className="">
                                  <i className="las la-user-friends mr-2 font-size-20"></i>
                                  01 Share
                                </a>
                        ...
                        <div className="col-lg-4 col-md-6">
                          <div className="card card-block card-stretch card-height card-bottom-border-success note-detail">
                            <div className="card-header d-flex justify-content-between pb-1">
                              <div className="icon iq-icon-box-2 icon-border-success rounded">
                                <svg
                                  width="23"
                                  height="23"
                                  className="svg-icon"
                              ...
                              <div className="card-header-toolbar d-flex align-items-center">
                                <div className="dropdown">
                                  ...
                                  >
                                    <a
                                      href="#"
                                      className="dropdown-item new-note6"
                                      data-toggle="modal"
                            ...
                            <div className="card-body rounded">
                              <h4 className="card-title">Benefits of NotePlus</h4>
                              <p className="mb-3 card-description short">
                                Take organized notes and share later as meeting
                                minutes or check-list with this simple
                                accessible Noteplus. Each note you create will
                                be stored on a virtual page of the NotePlus. You
                                can store groups of seperate notes. You can
                                store an unlimited number of separate notes
                                within the NotePlus.
                              </p>
                            </div>
                            <div className="card-footer">
                              <div className="d-flex align-items-center justify-content-between note-text note-text-success">
                                <a href="#" className="">
                                  <i className="las la-user-friends mr-2 font-size-20"></i>
                                  02 share
                                </a>
                      ...
                      <div className="row">
                        <div className="col-lg-4 col-md-6">
                          <div className="card card-block card-stretch card-height card-bottom-border-success note-detail">
                                ...
                                <div className="card-header-toolbar d-flex align-items-center">
                                  <div className="dropdown">
                                    ...
                                    >
                                      <a
                                        href="#"
                                        className="dropdown-item new-note7"
                                        data-toggle="modal"
                            ...
                            <div className="card-body rounded">
                              ...
                              <p className="mb-3 card-description short">
                                Need to write a summary note of the subject you
                                just finished? NotePlus lets you do in
                                on-the-go!
                              </p>
                              <p className="text-underline ellipsis-text short">
                        ...
                        <div className="col-lg-4 col-md-6">
                          <div className="card card-block card-stretch card-height card-bottom-border-warning note-detail">
                              ...
                              <div className="card-header-toolbar d-flex align-items-center">
                                <div className="dropdown">
                                  ...
                                  >
                                    <a
                                      href="#"
                                      className="dropdown-item new-note8"
                                      data-toggle="modal"
                            ...
                            <div className="card-body rounded">
                              <h4 className="card-title">Address & Email</h4>
                              <p className="mb-3 card-description short">
                                Quickly note down the address and email address
                                on NotePlus so that you can access it from
                                anywhere.
                              </p>
                            </div>
                            <div className="card-footer">
                        ...
                        <div className="col-lg-4 col-md-6">
                          <div className="card card-block card-stretch card-height card-bottom-border-info note-detail">
                                ...
                                <div className="card-header-toolbar d-flex align-items-center">
                                  <div className="dropdown">
                                    ...
                                    >
                                      <a
                                        href="#"
                                        className="dropdown-item new-note9"
                                        data-toggle="modal"
                            ...
                            <div className="card-body rounded">
                              ...
                              <p className="mb-3 card-description short">
                                With NotePlus, you can easily share via message,
                                WhatsApp, emails etc. You can also save your
                                notes and edit it later or can easily delete the
                                note.
                              </p>
                            </div>
                            <div className="card-footer">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td>
                                    ...
                                    <span>
                                      Chapter 1 notes, Chapter 2 Assignment,
                                      Chapter 3 practical File.
                                    </span>
                                  </td>
                                  <td>
                                ...
                                <tr>
                                  <td>
                                    <h4 className="mb-2">
                                      Image Notes
                                      <i className="las la-thumbtack ml-2"></i>
                                    </h4>
                                    <span>
                                      NotePlus lets you do in on-the-go!
                                    </span>
                                  </td>
                                  <td>
                                    <i className="las la-lock mr-2 font-size-20"></i>
                                ...
                                <tr>
                                  <td>
                                    <h4 className="mb-2">Benefits of NotePlus</h4>
                                    <span>
                                      Take organized notes and share later as
                                      meeting minutes or check-list
                                    </span>
                                  </td>
                                  <td>
                                    <i className="las la-user-friends mr-2 font-size-20"></i>
                                ...
                                <tr>
                                  <td>
                                    <h4 className="mb-2">Address & Email</h4>
                                    <span>
                  ...
                  <div id="note2" className="tab-pane fade">
                    <div className="icon active animate__animated animate__fadeIn i-grid">
                      <div className="row">
                        <div className="col-lg-4 col-md-6">
                          <div className="card card-block card-stretch card-height card-bottom-border-info note-detail">
                        ...
                        <div className="col-lg-4 col-md-6">
                          <div className="card card-block card-stretch card-height card-bottom-border-purple note-detail">
                            ...
                            <div className="card-body rounded">
                              ...
                              <ul className="pl-3 mb-0">
                                <li className="note-list">Cakes and Balloons.</li>
                              </ul>
                            </div>
                            <div className="card-footer">
                              <div className="d-flex align-items-center justify-content-between note-text note-text-purple">
                          ...
                          <div className="table-responsive">
                            <table className="table tbl-server-info">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td>
                                    <h4 className="mb-2">Lecture Notes</h4>
                                    <span>
                                      Chapter 1 notes, Chapter 2 Assignment,
                                      Chapter 3 practical File.
                                    </span>
                                ...
                                <tr>
                                  <td>
                                    <h4 className="mb-2">Birthday Celebration</h4>
                                    <span>
                                      You can easily share via message,
                                      WhatsApp, emails etc.
                                    </span>
                  ...
                  <div id="note3" className="tab-pane fade">
                    <div className="icon active animate__animated animate__fadeIn i-grid">
                      <div className="row">
                        <div className="col-lg-4 col-md-6">
                          <div className="card card-block card-stretch card-height card-bottom-border-purple note-detail">
                        ...
                        <div className="col-lg-4 col-md-6">
                          <div className="card card-block card-stretch card-height card-bottom-border-success note-detail mb-0">
                            <div className="card-header d-flex justify-content-between pb-1">
                              <div className="icon iq-icon-box-2 icon-border-success rounded">
                                <svg
                                  width="23"
                  ...
                  <div id="note4" className="tab-pane fade">
                    <div className="icon active animate__animated animate__fadeIn i-grid">
                      <div className="row">
                        <div className="col-lg-4 col-md-6">
                          <div className="card card-block card-stretch card-height card-bottom-border-warning note-detail">
                              ...
                              <tbody>
                                <tr>
                                  <td>
                                    <h4 className="mb-2">
                                      Essay Outline
                                      <i className="lar la-heart ml-2"></i>
                                    </h4>
                                    <span>
                                      Donec rutrum congue leo eget malesuada.
                                    </span>
